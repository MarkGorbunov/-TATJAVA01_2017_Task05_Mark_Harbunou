...
public class StAXParser {
    public void staxParser() throws StAXException {
        XMLInputFactory factory = XMLInputFactory.newInstance();
        InputStream input = null;
        try {
            input = new FileInputStream("menu1.xml");
            ...
            throw new StAXException("file not found in StAX parser", e);
        } catch (XMLStreamException e) {
            throw new StAXException("smth wrong in StAX parser", e);
        }

        // menu.forEach( (k,v) -> System.out.println("Key: " + k + ": Value: " + v));
    }

    private static HashMap<MenuTagName, ArrayList<Food>> process(XMLStreamReader reader) throws StAXException {
        ...
        try {
            ...
            throw new StAXException("smth wrong in XML stream in StAX parser", e);
        }
        return foodCategory;
    }
}
